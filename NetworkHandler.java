...
public class NetworkHandler {
    ...
    public void sendMouseEvent(int x, int y, int button) throws IOException {
        outputStream.writeObject(new MouseEvent(x, y, button));
        outputStream.flush();
    }

    public void sendKeyEvent(int keyCode) throws IOException {
        outputStream.writeObject(new KeyEvent(keyCode));
        outputStream.flush();
    }
